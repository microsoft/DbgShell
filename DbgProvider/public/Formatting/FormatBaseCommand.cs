...
namespace MS.Dbg.Formatting.Commands
{
    ...
    public abstract class FormatBaseCommand< TView > : FormatBaseCommand where TView : class
    {
        ...
        private bool m_alreadyAttemptedAutoGen;
        ...
        protected override void BeginProcessing()
        {
            ...
            else if( (null != Property) && (Property.Length > 0) )
            {
                ...
                m_view = GenerateViewFromPropertyProperty( cmd );
            }
        } // end BeginProcessing()
        ...
        protected override void ProcessRecord()
        {
            ...
            // WIP TODO: see the comment below? Does Out-Default need to also be updated to pay attention to -Property?
            // WIP TODO: How does -Force fit in now?
         ...
         //     ((null != Property) && (0 != Property.Length) && Force && !m_alreadyAutoGenerated) )
            if( !m_alreadyAttemptedAutoGen )
            {
                if( (null == m_view) || Force )
                {
                    m_view = GenerateView();
                }
                m_alreadyAttemptedAutoGen = true; // we don't want to come back in this block again!
            }
        ...
        protected TView GenerateViewFromPropertyProperty( string scriptCmd )
        {
            Collection< PSObject > results = null;
            ...
            using( DbgProvider.LeaseShell( out shell ) )
            {
                shell.AddCommand( scriptCmd ).AddParameter( "FromProperty", Property );
                ...
                if( shell.Streams.Error.Count > 0 )
                {
                    ...
                    return default( TView ); // satisfy compiler
                }
                else
                {
                    if( (null == results) || (0 == results.Count) )
        ...
        } // end GenerateViewFromPropertyProperty()
